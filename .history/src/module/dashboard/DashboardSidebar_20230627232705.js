...
import { setLight, setUser } from "../../store/global/globalSlice";
...
const DashboardSidebarStyled = styled.div`
  ...
  @media screen and (max-width: 1024px) {
    ...
    .sidebar-content {
      ...
      background-color: ${(props) => props.theme.bodyFourth};
      box-shadow: ${(props) =>
        props.theme === themeLight &&
        "10px 10px 20px rgba(218, 213, 213, 0.15)"};
      border-radius: 12px;
      opacity: 0;
      visibility: hidden;
      overflow: hidden;
  ...
  .sidebar-logo {
    ...
    .toggle-dashboard {
      ...
      @media screen and (max-width: 1024px) {
        ...
        padding: 8px;
        border-radius: 12px;
        box-shadow: rgba(89, 82, 82, 0.15) 1px 1px 4px 0px;
        background-color: ${(props) => props.theme.bgDropdown};
      }
    }
  }
  .sidebar-content {
  ...
  return (
    <DashboardSidebarStyled>
      <div className="sidebar-logo">
        ...
        <span className="toggle-dashboard" onClick={handleToggleDashboard}>
          {toggleDashboard ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-6 h-6"
      ...
      <div
        className={`sidebar-content ${
          toggleDashboard && "sidebar-content--active"
        }`}
      >
