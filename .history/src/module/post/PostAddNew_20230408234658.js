...
const PostAddNew = () => {
  ...
  // console.log("watch:", typeof watchStatus);
          ...
          <Field>
            ...
            <div className="status-wrap flex items-center gap-x-10">
              <Radio
                ...
                name="status"
                control={control}
                checked={watchStatus === Number(postStatus.APPROVED)}
              >
                Approved
              </Radio>
              <Radio
                ...
                name="status"
                control={control}
                checked={watchStatus === Number(postStatus.PENDING)}
              >
                Pending
              </Radio>
              <Radio
                ...
                name="status"
                control={control}
                checked={watchStatus === Number(postStatus.REJECT)}
              >
                Reject
              </Radio>
            </div>
