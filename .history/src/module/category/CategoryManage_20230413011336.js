...
const CategoryManage = () => {
  ...
  return (
    <div>
      ...
      ></DashboardHeading>
      <div className="search-postmanage max-w-[600px] w-full ml-auto mb-10 flex items-center justify-end gap-5">
        <Button
        ...
        <input
          ...
          className=" p-4 rounded-lg border border-solid border-gray-300"
        />
      </div>
      <Table>
        <table>
