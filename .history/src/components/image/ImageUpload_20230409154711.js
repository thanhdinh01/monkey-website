    ...
    <label className="group relative w-full h-[250px] flex items-center justify-center cursor-pointer rounded-lg overflow-hidden">
      ...
      {imageURL && (
        <Fragment>
          ...
          <button
            type="button"
            className="icon-image w-full h-full absolute flex items-center justify-center text-red-500 bg-slate-600 bg-opacity-5 group-hover:opacity-1 group-hover:visible opacity-0 invisible "
          >
            <svg
