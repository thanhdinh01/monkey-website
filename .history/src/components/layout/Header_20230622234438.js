    ...
    .menu-mobile {
      ...
      @media screen and (max-width: 414px) {
        ...
        .list-menu--mobile {
          ...
          box-shadow: rgb(89 82 82 / 15%) 0 10px 20px;
          position: absolute;
          top: 120%;
          left: 0;
          border-radius: 16px;
    ...
    .header-username {
      ...
      .profile-user {
        ...
        .profile-option {
          ...
          background-color: ${(props) => props.theme.greyColor};
          z-index: 10;
          box-shadow: rgba(218, 213, 213, 0.15) 0 10px 20px;
          p {
      ...
      <div className="container">
        <header className="header-main">
          ...
          <div className="menu-mobile">
            <span className="toggle-menu" onClick={handleToggleMobile}>
              <svg
            ...
            <div
              className={`list-menu--mobile ${
                menuMobile ? "visible opacity-100" : "invisible opacity-0"
              }`}
            >
              {navMenu.length > 0 &&
                navMenu.map((menu) => (
